...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="index.php"><img src="Assets/img/logo.png" /></a>
              ...
              <div class="col-4">
                <div class="text-left">
                    ...
                    <form method="post" action="loguearse.php">
                      ...
                      <input type="password" name="password" class="form-control mb-4" placeholder="Contreaseña" id="phone">
                      <button type="submit" class="btn btn-login btn-block">Ingresar</button>
                      <h5 class="mt-3">No ténes cuenta? <a href="registro.php">Registrate</a> </h5>
                    </form>
                </div>
              </div>
